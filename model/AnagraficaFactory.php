...
class AnagraficaFactory {
    ...
    public static function getAnagraficaByName($nomeOp,$cognomeOp) {
        $mysqli = ConnectionFactory::connetti();
    ...
    public static function setAnagrafica($nome,$cognome,$contatto) {
        $mysqli = ConnectionFactory::connetti();
    ...
    public static function updateAnagrafica($id,$nome,$cognome,$contatto) {
        $mysqli = ConnectionFactory::connetti();
